...
def test_score_main():
    response = client.post(
        ...
        json={
            ...
            'chapter_index': '1',
            'section_index': '1',
            'summary': 'Economics is about supply and demand, among other things. Economics is also about why people make decisions.',  # noqa: E501
        }
    )
    print('Short Summary:', response.json())
